...
public class ListAdapter extends BaseAdapter implements ThemedSpinnerAdapter {
    ...
    public ListAdapter(Context context, List<? extends Map<String, ?>> data,
        ...
        //Toast.makeText(context, url+" // "+imagen, Toast.LENGTH_LONG).show();
        //v=mInflater.inflate(R.layout.listview_activity, container, false);
        //image=v.findViewById(imagen);
