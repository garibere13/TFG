<?php 
  ...
  /*      //importing dbDetails file 
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
        ...
        if(isset($_POST['username']) and isset($_POST['izquierda']) and isset($_POST['arriba']) and isset($_POST['derecha']) and isset($_POST['abajo']) and isset($_FILES['image']['name']))
        {
                ...
                try
                {
                    ...
                    move_uploaded_file($_FILES['image']['tmp_name'], $file_path);
                        ...
                        $sql = "INSERT INTO fotos_perfil (id, url, username, izquierda, arriba, derecha, abajo) VALUES (NULL, '$file_url', '$username', $izquierda, $arriba, $derecha, $abajo);";
                        if(mysqli_query($con, $sql))
                            {
                                ...
                                $response['izquierda'] = $izquierda;
                                $response['arriba'] = $arriba;
                                $response['derecha'] = $derecha;
                                $response['abajo'] = $abajo;
                            }
                }
                catch(Exception $e)
                {
                 ...
                 try
                 {
                    ...
                    /* if(isset($_POST['nombre_hoyo']))
                     ...
                     if(isset($_POST['username']))
                     {
                        ...
                        //$sql = "select * from fotos where isProfile=true and username='$username'";
